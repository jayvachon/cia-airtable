...
const initial = (firstName, program, upcomingTerm) => {
	...
	let str = `<div dir="ltr"><p dir="ltr" style="line-height:1.38;margin-top:0pt;margin-bottom:0pt">Hello ${firstName},</p>
		...
		<p dir="ltr" style="line-height:1.38;margin-top:0pt;margin-bottom:0pt">We currently offer two courses: a 60-week Associate of Science in Computer Science and Web architecture course and a 45-week Web Development certificate course. Both courses start from the ground up with the fundamentals of programming. They cover front end development with HTML, CSS, and the JavaScript framework React.js; back end development using the JavaScript framework Node.js; and cloud computing with Amazon Web Services. The associate course also includes general education classes and an additional term of coding classes.<p>
		<br>
